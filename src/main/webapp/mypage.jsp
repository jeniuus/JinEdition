        ...
        <div class="container">
				...
				<div class="row justify-content-center mb-5" style="margin-top: 66px;">
					<div class="col-md-7 text-center">
						...
						<h3 class="heading-92913 text-black text-center">정보 수정</h3>
					</div>
				</div>
				...
				<div class="mypage-box">
					...
					<form class="" action="updateMem.do" method="post">		
							<!-- 아이디 start -->
							<div class="col-12">
								<div class="form-group">
									<h4 class="small-title">아이디</h4>
									<input class="form-control check" type="text" name="memId" id="id"
										value="${mem.memId}" placeholder="${mem.memId}" readonly>
								</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input class="form-control check" type="text" name="memName"
										id="name" value="${mem.memName}"
										placeholder="${mem.memName}">
								</div>
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input class="form-control check" name="memEmail" id="email"
										type="email" value="${mem.memEmail}"
										placeholder="${mem.memEmail}">
								</div>
