...
//==============로그인 유효성검사==============
      ...
      function emailCh() {//이메일 유효성
         var err = document.querySelector('#emailError');
            ...
            if (regEmail.test(input[7].value)) {
      ...
      input[3].addEventListener('keyup', idCh);
      //sns로그인 시 수정때문에 삭제
      input[4].addEventListener('keyup', pw1Ch);
      input[5].addEventListener('keyup', pw2Ch);
      input[6].addEventListener('keyup', nameCh);
      input[7].addEventListener('keyup', emailCh);
